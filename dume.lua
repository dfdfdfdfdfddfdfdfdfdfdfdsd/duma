...
local _dvh_ts = game:GetService("TweenService")
local _dvh_lt = game:GetService("Lighting")
local _dvh_cg = game:GetService("CoreGui")
local _dvh_pl = game:GetService("Players")

local function _dvh_tryProtect(sg)
    pcall(function()
...
local function _dvh_parentGui(sg)
    pcall(function()
        if type(gethui) == "function" then
            sg.Parent = gethui()
        end
    end)
    if sg.Parent then _dvh_tryProtect(sg) return end
    sg.Parent = _dvh_cg
    if sg.Parent then _dvh_tryProtect(sg) return end
    local lp = _dvh_pl.LocalPlayer
    if not lp then
        local ok = pcall(function() lp = _dvh_pl:WaitForChild("LocalPlayer", 20) end)
    ...
    if sg.Parent then _dvh_tryProtect(sg) end
end

local function _dvh_destroyNamed(name)
    local old = _dvh_cg:FindFirstChild(name)
...
pcall(function()
    for _, name in ipairs({"DieverHubTheme", "VxezeHubTheme", "Status_UI"}) do
        _dvh_destroyNamed(name)
    end
end)

local _dvh_gui = Instance.new("ScreenGui")
_dvh_gui.Name = "DieverHubTheme"
_dvh_gui.IgnoreGuiInset = true
_dvh_gui.ResetOnSpawn = false
_dvh_gui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
_dvh_gui.DisplayOrder = 100

local _dvh_oldBlur = _dvh_lt:FindFirstChild("VxezeBlur")
if _dvh_oldBlur then _dvh_oldBlur:Destroy() end

local _dvh_blur = Instance.new("BlurEffect")
_dvh_blur.Name = "VxezeBlur"
_dvh_blur.Size = 0
_dvh_blur.Parent = _dvh_lt

local _dvh_overlay = Instance.new("Frame")
_dvh_overlay.Name = "Overlay"
_dvh_overlay.Size = UDim2.new(1, 0, 1, 0)
_dvh_overlay.Position = UDim2.new(0, 0, 0, 0)
_dvh_overlay.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
_dvh_overlay.BackgroundTransparency = 0.35
_dvh_overlay.BorderSizePixel = 0
_dvh_overlay.Parent = _dvh_gui

local _dvh_grad = Instance.new("UIGradient")
_dvh_grad.Rotation = 90
_dvh_grad.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(8, 14, 28)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 0, 0)),
})
_dvh_grad.Parent = _dvh_overlay

local _dvh_main = Instance.new("Frame")
_dvh_main.Name = "Main"
_dvh_main.AnchorPoint = Vector2.new(0.5, 0.5)
_dvh_main.Position = UDim2.new(0.5, 0, 0.52, 0)
_dvh_main.Size = UDim2.new(0, 420, 0, 320)
_dvh_main.BackgroundTransparency = 1
_dvh_main.Parent = _dvh_gui

local _dvh_logo = Instance.new("ImageLabel")
_dvh_logo.Name = "Logo"
_dvh_logo.AnchorPoint = Vector2.new(0.5, 0.5)
_dvh_logo.Position = UDim2.new(0.5, 0, 0.28, 0)
_dvh_logo.Size = UDim2.new(0, 150, 0, 150)
_dvh_logo.BackgroundTransparency = 1
_dvh_logo.ImageTransparency = 0
_dvh_logo.ScaleType = Enum.ScaleType.Fit
_dvh_logo.Image = "rbxassetid://134841272452705"
_dvh_logo.Parent = _dvh_main

local _dvh_hubTitle = "Diever Hub"
local _dvh_title = Instance.new("TextLabel")
_dvh_title.Name = "Title"
_dvh_title.AnchorPoint = Vector2.new(0.5, 0.5)
_dvh_title.Position = UDim2.new(0.5, 0, 0.64, 0)
_dvh_title.Size = UDim2.new(0, 340, 0, 55)
_dvh_title.BackgroundTransparency = 1
_dvh_title.Text = _dvh_hubTitle
_dvh_title.TextColor3 = Color3.new(1, 1, 1)
_dvh_title.TextScaled = true
_dvh_title.Font = Enum.Font.SciFi
_dvh_title.TextTransparency = 0
_dvh_title.Parent = _dvh_main

local _dvh_titleMetal = Instance.new("UIGradient")
_dvh_titleMetal.Rotation = 95
_dvh_titleMetal.Color = ColorSequence.new({
...
_dvh_titleMetal.Parent = _dvh_title

local _dvh_titleStroke = Instance.new("UIStroke")
_dvh_titleStroke.Color = Color3.fromRGB(55, 42, 28)
_dvh_titleStroke.Thickness = 2.8
_dvh_titleStroke.Transparency = 0.15
pcall(function() _dvh_titleStroke.LineJoinMode = Enum.LineJoinMode.Round end)
_dvh_titleStroke.Parent = _dvh_title

local _dvh_glow = Instance.new("TextLabel")
_dvh_glow.Name = "Glow"
_dvh_glow.AnchorPoint = Vector2.new(0.5, 0.5)
_dvh_glow.Position = _dvh_title.Position
_dvh_glow.Size = _dvh_title.Size
_dvh_glow.BackgroundTransparency = 1
_dvh_glow.Text = _dvh_hubTitle
_dvh_glow.TextColor3 = Color3.new(1, 1, 1)
_dvh_glow.TextScaled = true
_dvh_glow.Font = Enum.Font.SciFi
_dvh_glow.TextTransparency = 0.72
_dvh_glow.ZIndex = _dvh_title.ZIndex - 1
_dvh_glow.Parent = _dvh_main

local _dvh_glowMetal = Instance.new("UIGradient")
_dvh_glowMetal.Rotation = 95
_dvh_glowMetal.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 190, 70)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(160, 175, 195)),
})
_dvh_glowMetal.Parent = _dvh_glow

-- Status display below title
L_1_[26] = Instance.new("TextLabel")
L_1_[26].Name = "StatusLabel"
L_1_[26].AnchorPoint = Vector2.new(0.5, 0)
L_1_[26].Position = UDim2.new(0.5, 0, 0.78, 0)
L_1_[26].Size = UDim2.new(0, 360, 0, 22)
L_1_[26].BackgroundTransparency = 1
L_1_[26].Text = "Status : N/A"
L_1_[26].TextColor3 = Color3.fromRGB(255, 236, 200)
L_1_[26].TextSize = 16
L_1_[26].Font = Enum.Font.GothamSemibold
L_1_[26].TextXAlignment = Enum.TextXAlignment.Center
L_1_[26].TextTransparency = 0
L_1_[26].Parent = _dvh_main

local _dvh_statusGrad = Instance.new("UIGradient")
_dvh_statusGrad.Rotation = 90
_dvh_statusGrad.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 230, 170)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(180, 195, 215)),
})
_dvh_statusGrad.Parent = L_1_[26]

-- Farm status indicator below status
local _dvh_farmStatus = Instance.new("TextLabel")
_dvh_farmStatus.Name = "FarmIndicator"
_dvh_farmStatus.AnchorPoint = Vector2.new(0.5, 0)
_dvh_farmStatus.Position = UDim2.new(0.5, 0, 0.86, 0)
_dvh_farmStatus.Size = UDim2.new(0, 300, 0, 18)
_dvh_farmStatus.BackgroundTransparency = 1
_dvh_farmStatus.Text = "Waiting..."
_dvh_farmStatus.TextColor3 = Color3.fromRGB(170, 180, 200)
_dvh_farmStatus.TextSize = 13
_dvh_farmStatus.Font = Enum.Font.Gotham
_dvh_farmStatus.TextXAlignment = Enum.TextXAlignment.Center
_dvh_farmStatus.TextTransparency = 0.2
_dvh_farmStatus.Parent = _dvh_main

local _dvh_discord = Instance.new("TextLabel")
_dvh_discord.Name = "Discord"
_dvh_discord.AnchorPoint = Vector2.new(0, 1)
_dvh_discord.Position = UDim2.new(0, 18, 1, -14)
_dvh_discord.Size = UDim2.new(0, 340, 0, 30)
_dvh_discord.BackgroundTransparency = 1
_dvh_discord.Text = "discord.gg/Suxv39x9ZS"
_dvh_discord.TextXAlignment = Enum.TextXAlignment.Left
_dvh_discord.Font = Enum.Font.GothamSemibold
_dvh_discord.TextSize = 22
_dvh_discord.TextColor3 = Color3.fromRGB(220, 220, 220)
_dvh_discord.TextTransparency = 0
_dvh_discord.Parent = _dvh_gui

local _dvh_toast = Instance.new("Frame")
_dvh_toast.Name = "ThemeActiveToast"
_dvh_toast.AnchorPoint = Vector2.new(1, 1)
_dvh_toast.Position = UDim2.new(1, 320, 1, -18)
_dvh_toast.Size = UDim2.new(0, 300, 0, 46)
_dvh_toast.BackgroundColor3 = Color3.fromRGB(14, 14, 18)
_dvh_toast.BackgroundTransparency = 0.12
_dvh_toast.BorderSizePixel = 0
_dvh_toast.ZIndex = 200
_dvh_toast.Parent = _dvh_gui

local _dvh_toastCorner = Instance.new("UICorner")
_dvh_toastCorner.CornerRadius = UDim.new(0, 12)
_dvh_toastCorner.Parent = _dvh_toast

local _dvh_toastStroke = Instance.new("UIStroke")
_dvh_toastStroke.Color = Color3.fromRGB(210, 185, 120)
_dvh_toastStroke.Thickness = 1.2
_dvh_toastStroke.Transparency = 0.35
_dvh_toastStroke.Parent = _dvh_toast

local _dvh_toastGrad = Instance.new("UIGradient")
_dvh_toastGrad.Rotation = 90
_dvh_toastGrad.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 28, 22)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(18, 18, 24)),
})
_dvh_toastGrad.Parent = _dvh_toast

local _dvh_toastText = Instance.new("TextLabel")
_dvh_toastText.Name = "ToastText"
_dvh_toastText.AnchorPoint = Vector2.new(0, 0.5)
_dvh_toastText.Position = UDim2.new(0, 14, 0.5, 0)
_dvh_toastText.Size = UDim2.new(1, -52, 0, 22)
_dvh_toastText.BackgroundTransparency = 1
_dvh_toastText.Font = Enum.Font.GothamSemibold
_dvh_toastText.TextSize = 15
_dvh_toastText.TextXAlignment = Enum.TextXAlignment.Left
_dvh_toastText.TextColor3 = Color3.fromRGB(255, 236, 200)
_dvh_toastText.Text = "Diever Hub \226\128\148 Done"
_dvh_toastText.Parent = _dvh_toast

local _dvh_toastIcon = Instance.new("TextLabel")
_dvh_toastIcon.Name = "ToastIcon"
_dvh_toastIcon.AnchorPoint = Vector2.new(1, 0.5)
_dvh_toastIcon.Position = UDim2.new(1, -10, 0.5, 0)
_dvh_toastIcon.Size = UDim2.new(0, 22, 0, 22)
_dvh_toastIcon.BackgroundTransparency = 1
_dvh_toastIcon.Text = "\226\156\147"
_dvh_toastIcon.TextColor3 = Color3.fromRGB(200, 255, 160)
_dvh_toastIcon.Font = Enum.Font.GothamBold
_dvh_toastIcon.TextSize = 16
_dvh_toastIcon.Parent = _dvh_toast

_dvh_parentGui(_dvh_gui)

if not _dvh_gui.Parent then
    warn("[DieverHub] Khong parent duoc ScreenGui.")
end

_dvh_ts:Create(_dvh_toast, TweenInfo.new(0.45, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    Position = UDim2.new(1, -18, 1, -18),
}):Play()

task.delay(8, function()
    if not _dvh_toast or not _dvh_toast.Parent then return end
    local ti = TweenInfo.new(0.45, Enum.EasingStyle.Quad, Enum.EasingDirection.In)
    _dvh_ts:Create(_dvh_toast, ti, { BackgroundTransparency = 1 }):Play()
    _dvh_ts:Create(_dvh_toastStroke, ti, { Transparency = 1 }):Play()
    _dvh_ts:Create(_dvh_toastText, ti, { TextTransparency = 1 }):Play()
    _dvh_ts:Create(_dvh_toastIcon, ti, { TextTransparency = 1 }):Play()
    task.delay(0.5, function()
        pcall(function() _dvh_toast:Destroy() end)
    end)
end)

_dvh_ts:Create(_dvh_blur, TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
    Size = 18,
}):Play()

task.spawn(function()
    while _dvh_gui.Parent do
        local up = _dvh_ts:Create(_dvh_logo, TweenInfo.new(1.2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
            Size = UDim2.new(0, 158, 0, 158),
        })
        local down = _dvh_ts:Create(_dvh_logo, TweenInfo.new(1.2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
...
-- Sync farm status with status label
task.spawn(function()
    local lastText = ""
    while _dvh_gui.Parent do
        task.wait(0.5)
        pcall(function()
            if L_1_[26] and L_1_[26].Text ~= lastText then
                lastText = L_1_[26].Text
                _dvh_farmStatus.Text = lastText
            end
        end)
    end
end)
